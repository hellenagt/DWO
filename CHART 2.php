...
$sql = "SELECT concat('name:', s.tahun) as name, concat('y:',SUM(fp.amount)*100/'" . $total[0] . "') as y, concat('drilldown:', s.tahun) as drilldown
FROM fakta_pendapatan fp JOIN time s ON fp.time_id=s.time_id
GROUP BY s.tahun";
...
<body>
  ...
  Highcharts.chart('container', {
    ...
    title: {
      text: 'Persentase Jumlah Nilai Penjualan Berdasarkan Tahun  (WH Sakila)'
    },
    subtitle: {
